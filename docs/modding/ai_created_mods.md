...
| [Captain Substitute Mastery Improved](https://www.nexusmods.com/granbluefantasyrelink/mods/714) || Undisclosed source code | Oddly named classes `StandaloneSkillboardFieldCoordinator`, improper use of interfaces - uses reflection to fetch "GetModdedOrAchiveFile" instead of calling the function directly..?
...
| [Sigil Picker](https://www.nexusmods.com/granbluefantasyrelink/mods/702) | [Source](https://github.com/Evoyn/gbfer-sigils-picker) | Source Code | Explicit AI usage disclosure (mod tag).
